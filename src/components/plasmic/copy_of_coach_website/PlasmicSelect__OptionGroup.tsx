...
import * as sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: Zu3eBY7B1QZ9hx/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: B8Cwqg4a8Fcb0T/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__kvbQq)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__yRPfC)}
              />
            </React.Fragment>
          ),
          value: args.children
